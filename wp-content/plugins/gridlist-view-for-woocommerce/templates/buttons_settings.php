...
<table class="form-table lgv_admin_settings buttons">
    <tr>
        ...
        <td>
            ...
            <button type="button" class="button br_grid_list_page_add"><?php _e('Add page', 'BeRocket_LGV_domain'); ?></button>
            <ul class="br_grid_list_pages">
                <?php
                if( isset($options['pages']) && is_array($options['pages']) ) {
                    foreach($options['pages'] as $page_id => $style) {
                        $text = '';
                        ...
                        $text .= ': ' . $styles[$style];
                        echo '<li class="br_grid_list_page_id id_'.$page_id.'"><input type="hidden" name="br_lgv_buttons_page_option[pages]['.$page_id.']" value="'.$style.'"><button type="button" class="button br_grid_list_page_remove">'.$text.'</button></li>';
                    }
                }
                ?>
            </ul>
    ...
    <tr>
        <th scope="row"><?php _e('Disable Font Awesome', 'BeRocket_LGV_domain') ?></th>
        <td>
            <label>
                <input name="br_lgv_buttons_page_option[fontawesome_frontend_disable]" value="1" type="checkbox"<?php echo ($options['fontawesome_frontend_disable'] ? ' checked' : ''); ?>>
                <?php _e('Don\'t loading css file for Font Awesome on site front end. Use it only if you doesn\'t uses Font Awesome icons in widgets or you have Font Awesome in your theme.', 'BeRocket_LGV_domain') ?>
            </label>
        </td>
    </tr>
    <tr>
        <th scope="row"><?php _e('Font Awesome Version', 'BeRocket_LGV_domain') ?></th>
        <td>
            <select name="br_lgv_buttons_page_option[fontawesome_frontend_version]">
                <option value=""<?php if(isset($options['fontawesome_frontend_version']) && $options['fontawesome_frontend_version'] == '') echo ' selected'; ?>><?php _e('Font Awesome 4', 'BeRocket_LGV_domain') ?></option>
                <option value="fontawesome5"<?php if(isset($options['fontawesome_frontend_version']) && $options['fontawesome_frontend_version'] == 'fontawesome5') echo ' selected'; ?>><?php _e('Font Awesome 5', 'BeRocket_LGV_domain') ?></option>
            </select>
            <?php _e('Version of Font Awesome that will be used on front end. Please select version that you have in your theme', 'BeRocket_LGV_domain'); ?>
        </td>
    </tr>
    <tr>
