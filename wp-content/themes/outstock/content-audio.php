	...
	<?php if ( ! post_password_required() && ! is_attachment() ) : ?>
		<?php 
			if ( is_single() ) { ?>
				...
				<?php } ?>
				<div class="player"><?php echo do_shortcode(get_post_meta( get_the_ID(), 'lionthemes_featured_post_value', true )); ?></div>
			<?php }
		?>
		<?php if ( !is_single() ) { ?>
			<?php if ( has_post_thumbnail() ) { ?>
	...
	<?php endif; ?>
		<div class="post-info<?php if ( !has_post_thumbnail() ) { echo ' no-thumbnail';} ?>">
			...
			<?php } else { ?> 
				...
				<?php else : ?>
					<div class="entry-summary">
						<div class="player"><?php echo do_shortcode(get_post_meta( get_the_ID(), 'outstock_featured_post_value', true )); ?></div>
						<?php the_excerpt(); ?>
					</div>
