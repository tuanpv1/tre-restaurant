...
$menu_col = '';
if(!class_exists('WC_Widget_Cart') && !class_exists('WC_Widget_Product_Search')) {
	$menu_col = 'col-90';
	if (!is_active_sidebar('top_header')) $menu_col = 'col-100';
}
?>
			...
			<div class="header">
				<div class="row">
					...
					<div class="col-md-9 col-sm-9 col-xs-12 col-search">
						<div class="nav-menus pull-left <?php echo esc_attr($menu_col) ?>">
