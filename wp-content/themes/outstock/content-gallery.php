...
<article id="post-<?php the_ID(); ?>" <?php post_class($blogcolumn); ?>>
	...
	<?php 
		if ( get_post_meta( get_the_ID(), 'lionthemes_featured_post_value', true ) || has_post_thumbnail() ) { ?>
			<div class="post-thumbnail">
				<?php echo do_shortcode(get_post_meta( get_the_ID(), 'lionthemes_featured_post_value', true )); ?>
				<?php if (!get_post_meta( get_the_ID(), 'lionthemes_featured_post_value', true )) { ?>
					<?php if ( is_single() ) { ?>
	...
	<?php endif; ?>
		...
		<div class="post-info<?php if ( !has_post_thumbnail() && !get_post_meta( get_the_ID(), 'lionthemes_featured_post_value', true ) ) { echo ' no-thumbnail';} ?>">
