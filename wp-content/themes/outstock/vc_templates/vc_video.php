...
$output = '
	...
	if(!empty($lightbox)){
		$output .= '<a class="vc-video-popup" data-link="'. esc_attr($link) .'" href="javascript:void(0)"><i class="fa fa-play-circle-o"></i></a>';
		if(!empty($content)) $output .= $content;
		$output .= '<div class="wpb_video_wrapper v-lightbox"><div class="overlay-bg"></div><div class="iframe_wrap"><a class="v-close" href="javascript:void(0)"><i class="fa fa-times-circle-o"></i></a>' . $embed . '</div></div>';
	}else{
